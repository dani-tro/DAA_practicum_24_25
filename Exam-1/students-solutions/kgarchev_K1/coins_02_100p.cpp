...
ll countMaxCoinsWith(ll dist)
{
    ...
    //cout <<"After " <<0 <<" new count: " <<res <<" last: "<<last <<endl;
    for(int i = 1; i < m; ++i)
    {
        ...
        //cout <<"After " <<i <<" new count: " <<res <<" last: "<<last <<endl;
    }
...
int main()
{
    ...
    sort(gredi, gredi + m, [](const gr a, const gr b){ return a.l < b.l;});


    //cout <<countMaxCoinsWith(2)<<endl;
